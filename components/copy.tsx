...
export const CopyCard = ({ text, text2 }: { text: string; text2?: string }) => {
  ...
  return (
    <div className="flex flex-col rounded-lg overflow-hidden my-6">
      ...
      <div className="text-base bg-black px-6 py-5">
        <p className="text-gray-300 flex flex-col gap-y-2">{text}</p>
        {text2 && (
          <p className="text-gray-300 flex flex-col gap-y-2">{text2}</p>
        )}
      </div>
    </div>
  );
